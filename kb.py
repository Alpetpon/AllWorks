...
keyboard_prof: ReplyKeyboardMarkup = ReplyKeyboardMarkup(keyboard=[[button_1], [button_2]],  resize_keyboard=True)


button_3: KeyboardButton = KeyboardButton(text=text.contin)
button_4: KeyboardButton = KeyboardButton(text=text.back)
...
button_6: KeyboardButton = KeyboardButton(text=text.back)
...
button_11: KeyboardButton = KeyboardButton(text = text.back)
